...
- [技術レポートを書く](https://docs.google.com/document/d/1pN0-V7FFfZClCOHSM--se3JSA0FP20g7aP54_6T6mmw/)
- ドキュメントの作成と共有
  - WebブラウザーでGmailを開いて、ログイン
  - Googleアプリから、Googleドライブを開く
  - 新規ボタンをクリックして、Googleドキュメントを作成する
  - 無題のドキュメントをクリックして、「技術レポート：氏名」というタイトルにする
  - 共有ボタンをクリックして、以下を設定する
    - 一般的なアクセスを、「制限付き」から「リンクを知っている全員」に切り替える
    - リンクをコピーする
    - 完了ボタンをクリックする
    - 本ページの上部のURLなどの報告から、URLを報告する
- 卒業制作や個人制作からテーマを検討
  - 共有したドキュメントに、案を箇条書きする
  - 案が決まったら、調査したり、目次をかく
  - 参照したWebサイトのURLを記載する
